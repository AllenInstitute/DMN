...
def main():
    ...
    for isid in matches['id']:
        ...
        print([structure for structure in unionizes[(unionizes['hemisphere_id'] == 1) &
                                                           (unionizes['experiment_id'] == isid)]['structure_id'].unique() if structure not in unionizes[(unionizes['hemisphere_id'] == 1) &
                                                           (unionizes['experiment_id'] == args.id)]['structure_id'].values])
        print([structure for structure in unionizes[(unionizes['hemisphere_id'] == 2) &
                                                           (unionizes['experiment_id'] == isid)]['structure_id'].unique() if structure not in unionizes[(unionizes['hemisphere_id'] == 2) &
                                                           (unionizes['experiment_id'] == args.id)]['structure_id'].values])
