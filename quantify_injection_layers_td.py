...
dat = pd.read_csv(os.path.join(path, 'td_wt_cre_matched_correlations_NPV_ipsi.csv'))
...
dat.to_csv(os.path.join(path, 'td_wt_cre_matched_correlations_NPV_ipsi_with_inj_corr.csv'), 
           index  = False)